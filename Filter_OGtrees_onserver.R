...
OG_clans <- loadRData(paste('/mnt/users/garethg/git/resam/orthogroups_2017/',
...
# OG_clantable <- loadRData(paste('/mnt/users/garethg/git/resam/orthogroups_2017/',
...
Omyk.duplicates <- read.table(paste('/mnt/users/melavan/duplicate_tables/',
                                    'Omyk_RefSeq_2017_Ss4R_ohnologs_',
                                   'blastidentification_minpident80.txt', sep = ''),
                              header = T)[,1:2]

Ssal.duplicates <- read.table(paste('/mnt/users/melavan/duplicate_tables/',
...
length(OG_clans_dupl_Eluc_filt)
